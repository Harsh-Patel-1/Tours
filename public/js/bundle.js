    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _stripeJs.loadStripe)('pk_test_51QZEUQSB8H1cddRI6aTrmi3ZhGr7AONkSZPqbnFJ6wx0oIsDbn36DydD0dMziHaxcitGAtRIPAZsubJRHr9KlmnT00YiS5ynJD');
        case 3:
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          console.error('Error initializing Stripe:', _context.t0);
        case 11:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          (0, _alerts.showAlert)('error', _context2.t0.message || 'Something went wrong!');
        case 14:
        case "end":
          return _context2.stop();
      }
...
},{"@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (bookTourBtn) {
    bookTourBtn.addEventListener('click', function (event) {
      event.target.textContent = 'Processing...'; // Update button text
      var tourId = bookTourBtn.dataset.tourId;
      console.log('Tour ID:', tourId); // For debugging
      (0, _stripe.bookTour)(tourId); // Call your booking function
    });
  } else {
